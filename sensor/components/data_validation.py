...
class DataValidation:
    ...
    def drop_zero_std_columns(self,dataframe)->pd.DataFrame:
        try:
            ...
            if zero_std_cols:
                dataframe = dataframe.drop(columns=zero_std_cols)
                logging.info(f"Dropped columns with zero standard deviation: {zero_std_cols}")
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            # Drop column with zero Standard Deviation validation check
            train_dataframe = self.drop_zero_std_columns(train_dataframe)
            test_dataframe = self.drop_zero_std_columns(train_dataframe)
